function onLoad()
    ...
    -- heavy
    cardInfo.upgradeCards.z6Trooper = {name = "Z-6 Trooper", ptCost = 20, miniInfo = miniInfo.z6Trooper,varName="z6Trooper"}
    cardInfo.upgradeCards.hh12Stormtrooper = {name = "HH-12 Stormtrooper", ptCost = 20, miniInfo = miniInfo.hh12Stormtrooper,varName="hh12Stormtrooper"}
    ...
    cardInfo.upgradeCards.dlt19Stormtrooper = {name = "DLT-19 Stormtrooper", ptCost = 22, miniInfo = miniInfo.dlt19Stormtrooper,varName="dlt19Stormtrooper"}
    cardInfo.upgradeCards.t7IonSnowtrooper = {name = "T-7 Ion Snowtrooper", ptCost = 20, miniInfo = miniInfo.t7IonSnowtrooper,varName="t7IonSnowtrooper"}
    cardInfo.upgradeCards.flametrooper = {name = "Flametrooper", ptCost = 20, miniInfo = miniInfo.flametrooper, varName="flametrooper"}
    cardInfo.upgradeCards.scatterGunTrooper = {name = "Scatter Gun Trooper", ptCost = 23, miniInfo = miniInfo.scatterGunTrooper,varName="scatterGunTrooper"}
    cardInfo.upgradeCards.mpl57BarrageTrooper = {name = "MPL-57 Barrage Trooper", ptCost = 22, miniInfo = miniInfo.mpl57BarrageTrooper,varName="mpl57BarrageTrooper"}
    cardInfo.upgradeCards.electrostaffGuard = {name = "Electrostaff Guard", ptCost = 25, miniInfo = miniInfo.electrostaffGuard,varName="electrostaffGuard"}
    cardInfo.upgradeCards.dh447Sniper = {name = "DH-447 Sniper", ptCost = 28, miniInfo = miniInfo.dh447Sniper,varName="dh447Sniper"}
    cardInfo.upgradeCards.protonChargeSaboteur = {name = "Proton Charge Saboteur", ptCost = 26, miniInfo = miniInfo.protonChargeSaboteur,varName="protonChargeSaboteur"}
    cardInfo.upgradeCards.bowcasterWookiee = {name = "Bowcaster Wookiee", ptCost = 31, miniInfo = miniInfo.bowcasterWookiee,varName="bowcasterWookiee"}
    cardInfo.upgradeCards.dh447SniperLeader = {name = "DH-447 Sniper", ptCost = 28, miniInfo = miniInfo.dh447SniperLeader,varName="dh447SniperLeader"}
    cardInfo.upgradeCards.protonChargeSaboteurLeader = {name = "Proton Charge Saboteur", ptCost = 26, miniInfo = miniInfo.protonChargeSaboteurLeader,varName="protonChargeSaboteurLeader"}
    cardInfo.upgradeCards.dlt19xSniper = {name = "DLT-19x Sniper", ptCost = 28, miniInfo = miniInfo.dlt19xSniper,varName="dlt19xSniper"}
    cardInfo.upgradeCards.sonicChargeSaboteurLeader = {name = "Sonic Charge Saboteur", ptCost = 26, miniInfo = miniInfo.sonicChargeSaboteurLeader,varName="sonicChargeSaboteurLeader"}
    cardInfo.upgradeCards.dlt19xSniperLeader = {name = "DLT-19x Sniper", ptCost = 28, miniInfo = miniInfo.dlt19xSniperLeader,varName="dlt19xSniperLeader"}
    cardInfo.upgradeCards.sonicChargeSaboteur = {name = "Sonic Charge Saboteur", ptCost = 26, miniInfo = miniInfo.sonicChargeSaboteur,varName="sonicChargeSaboteur"}
    cardInfo.upgradeCards.isfT21 = {name = "T-21 Special Forces Trooper", ptCost = 29, miniInfo = miniInfo.isfT21,varName="isfT21"}
    cardInfo.upgradeCards.delMeeko = {name = "Del Meeko", ptCost = 38, miniInfo = miniInfo.delMeeko,varName="delMeeko"}
    cardInfo.upgradeCards.gideonHask = {name = "Gideon Hask", ptCost = 38, miniInfo = miniInfo.gideonHask,varName="gideonHask"}
    cardInfo.upgradeCards.beskadDuelist = {name = "Beskad Duelist", ptCost = 28, miniInfo = miniInfo.beskadDuelist,varName="beskadDuelist"}
    cardInfo.upgradeCards.ursaWren = {name = "Ursa Wren", ptCost = 38, miniInfo = miniInfo.ursaWren,varName="ursaWren"}
    cardInfo.upgradeCards.tristanWren = {name = "Tristan Wren", ptCost = 38, miniInfo = miniInfo.tristanWren,varName="tristanWren"}
    ...
    cardInfo.upgradeCards.dp23PhaseITrooper = {name = "DP-23 Phase I Trooper", ptCost = 23, miniInfo = miniInfo.dp23PhaseITrooper,varName="dp23PhaseITrooper"}
    cardInfo.upgradeCards.rps6PhaseITrooper = {name = "RPS-6 Phase I Trooper", ptCost = 21, miniInfo = miniInfo.rps6PhaseITrooper,varName="rps6PhaseITrooper"}
    cardInfo.upgradeCards.e5sB1Trooper = {name = "E-5s B1 Trooper", ptCost = 20, miniInfo = miniInfo.e5sB1Trooper,varName="e5sB1Trooper"}
    cardInfo.upgradeCards.radiationCannonB1Trooper = {name = "Radiation Cannon B1 Trooper", ptCost = 22, miniInfo = miniInfo.radiationCannonB1Trooper,varName="radiationCannonB1Trooper"}
    cardInfo.upgradeCards.rt97CStormtrooper = {name = "RT-97C Stormtrooper", ptCost = 26, miniInfo = miniInfo.rt97CStormtrooper,varName="rt97CStormtrooper"}
    cardInfo.upgradeCards.t21Stormtrooper = {name = "T-21 Stormtrooper", ptCost = 24, miniInfo = miniInfo.t21Stormtrooper,varName="t21Stormtrooper"}
    cardInfo.upgradeCards.sx21Trooper = {name = "SX-21 Trooper", ptCost = 17, miniInfo = miniInfo.sx21Trooper,varName="sx21Trooper"}
    cardInfo.upgradeCards.dlt20ATrooper = {name = "DLT-20A Trooper", ptCost = 26, miniInfo = miniInfo.dlt20ATrooper,varName="dlt20ATrooper"}
    ...
    cardInfo.upgradeCards.pao = {name = "Pao", ptCost = 22, miniInfo = miniInfo.pao,varName="pao"}
    cardInfo.upgradeCards.bistan = {name = "Bistan", ptCost = 32, miniInfo = miniInfo.bistan,varName="bistan"}

    cardInfo.upgradeCards.dtf16 = {name = "DT-F16", ptCost = 22, miniInfo = miniInfo.dtf16,varName="dtf16"}
    cardInfo.upgradeCards.dlt19DTrooper = {name = "DLT-19D Trooper", ptCost = 34, miniInfo = miniInfo.dlt19DTrooper,varName="dlt19DTrooper"}

    cardInfo.upgradeCards.cm093Trooper = {name = "CM-0/93 Trooper", ptCost = 26, miniInfo = miniInfo.cm093Trooper,varName="cm093Trooper"}
    cardInfo.upgradeCards.t21BTrooper = {name = "T-21B Trooper", ptCost = 35, miniInfo = miniInfo.t21BTrooper,varName="t21BTrooper"}

    cardInfo.upgradeCards.z6PhaseITrooper = {name = "Z-6 Phase I Trooper", ptCost = 23, miniInfo = miniInfo.z6PhaseITrooper,varName="z6PhaseITrooper"}
    cardInfo.upgradeCards.dc15PhaseITrooper  = {name = "DC-15 Phase I Trooper", ptCost = 27, miniInfo = miniInfo.dc15PhaseITrooper, varName="dc15PhaseITrooper"}
    cardInfo.upgradeCards.e60RB1Trooper = {name = "E-60R B1 Trooper", ptCost = 20, miniInfo = miniInfo.e60RB1Trooper,varName="e60RB1Trooper"}
    cardInfo.upgradeCards.e5CB1Trooper = {name = "E-5C B1 Trooper", ptCost = 18, miniInfo = miniInfo.e5CB1Trooper,varName="e5CB1Trooper"}
    ...
    cardInfo.upgradeCards.rebelOfficer = {name = "Rebel Officer", ptCost = 16, miniInfo = miniInfo.rebelOfficerLeader,varName="rebelOfficer"}
    cardInfo.upgradeCards.imperialOfficer = {name = "Imperial Officer", ptCost = 17, miniInfo = miniInfo.imperialOfficerLeader,varName="imperialOfficer"}
    ...
    cardInfo.upgradeCards.tSeriesTacticalDroid = {name =  "T-Series Tactical Droid", ptCost = 18, miniInfo = miniInfo.tSeriesTacticalDroid,varName="tSeriesTacticalDroid"}

    cardInfo.upgradeCards.phaseICloneSpecialist = {name = "Phase I Clone Specialist", ptCost = 14, miniInfo = miniInfo.phaseICloneSpecialist,varName="phaseICloneSpecialist"}
    cardInfo.upgradeCards.phaseICloneCaptain = {name = "Phase I Clone Captain", ptCost = 14, miniInfo = miniInfo.phaseICloneCaptain,varName="phaseICloneCaptain"}
    cardInfo.upgradeCards.oomSeriesBattleDroid = {name = "OOM-Series Battle Droid", ptCost = 9, miniInfo = miniInfo.oomSeriesBattleDroid,varName="oomSeriesBattleDroid"}
    cardInfo.upgradeCards.b1SecurityDroid = {name = "B1 Security Droid", ptCost = 7, miniInfo = miniInfo.b1SecurityDroid,varName="b1SecurityDroid"}
    cardInfo.upgradeCards.stormtrooperCaptain = {name = "Stormtrooper Captain", ptCost = 12, miniInfo = miniInfo.stormtrooperCaptain,varName="stormtrooperCaptain"}
    cardInfo.upgradeCards.stormtrooperSpecialist = {name = "Stormtrooper Specialist", ptCost = 12, miniInfo = miniInfo.stormtrooperSpecialist,varName="stormtrooperSpecialist"}
    cardInfo.upgradeCards.rebelTrooperSpecialist = {name = "Rebel Trooper Specialist", ptCost = 12, miniInfo = miniInfo.rebelTrooperSpecialist,varName="rebelTrooperSpecialist"}
    cardInfo.upgradeCards.rebelTrooperCaptain = {name = "Rebel Trooper Captain", ptCost = 11, miniInfo = miniInfo.rebelTrooperCaptain,varName="rebelTrooperCaptain"}
