...
function resetButtons()
    ...
    if selectedUnitObj != nil then
        ...
        self.createButton({
            ...
            tooltip = "Take a Suppression token"
        })
...
function surge()
    ...
    bag = getObjectFromGUID(Global.getVar("surgeBagGUID"))
    bag.takeObject({
        position = tokenPosition,
        rotation = tokenRotation
    })
...
function suppression()
    ...
    bag = getObjectFromGUID(Global.getVar("suppressionBagGUID"))
    bag.takeObject({
        position = tokenPosition,
        rotation = tokenRotation
    })
